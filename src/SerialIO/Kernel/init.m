...
(*Implementation*)
$Link = Install[
	If[ValueQ[$ArduinoSerialIODirectory],
		FileNameJoin[{$ArduinoSerialIODirectory, $OperatingSystem, "SerialIO"}],
		"/Users/Keshav/Documents/Wolfram/ArduinoLink/src/SerialIO/MacOSX/SerialIO"], LinkProtocol -> "Pipes"];
